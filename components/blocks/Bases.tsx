      ...
      <section className="bases py-32">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-16">
            <div>
              <h3 className="text-xl text-gray-400 pb-4">Проверка задолженностей по базе ФССП</h3>
            ...
            <div>
              <h3 className="text-xl text-gray-400 pb-4">Проверка запрета на выезд за границу</h3>
              <p className="text-xs text-gray-600">
            ...
            <div>
              <h3 className="text-xl text-gray-400 pb-4">Реестр лиц, находящихся в розыске ФССП</h3>
              <p className="text-xs text-gray-600">
            ...
            <div>
              <h3 className="text-xl text-gray-400 pb-4">Проверка налоговой задолженности по ИНН</h3>
              <p className="text-xs text-gray-600">
                Бесплатная онлайн проверка задолженностей по судебным приставам
                с возможностью погасить долг онлайн прямо на сайте
              </p>
