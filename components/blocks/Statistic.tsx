    ...
    <section>
      <div className="container mx-auto py-8 overflow-auto">
        ...
        <table className="w-full">
          <tr className="bg-gray-50 border-b-2 border-gray-200 text-sm text-gray-500 text-center">
          ...
          <tr className="text-xs text-center">
            ...
            <td className="p-4">
              Исполнительный лист от 14.09.2020 № ФС № 009215334 ПЕНЗЕНСКИЙ
              РАЙОННЫЙ СУД
            </td>
          ...
          <tr className="text-xs text-center">
            ...
            <td className="p-4">
              Исполнительный лист от 14.09.2022 № ФС 038670960 ПРИВОЛЖСКИЙ
          ...
          <tr className="text-xs text-center">
            ...
            <td className="p-4">
              Судебный приказ от 15.06.2022 № 2-1146/2022 Постановление о
