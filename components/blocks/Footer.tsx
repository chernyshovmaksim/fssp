            ...
            <footer className="bg-gray-200 py-16">
                <div className="container mx-auto">
                    <div>
                        ...
                        <span className="text-gray-500 text-xs text-center block">Поиск долгов в банке данных судебных приставов</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-xs text-gray-500 mt-8">
                        ...
                        <div>E-mail: <Link href="mailto://moi-dolgi1@gmail.com">moi-dolgi1@gmail.com</Link></div>
                    </div>
                </div>
            </footer>
        </>
